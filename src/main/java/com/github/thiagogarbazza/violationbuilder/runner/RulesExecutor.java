...
public class RulesExecutor {
  ...
  public static <T> void rulesExecutor(final Collection<ValidationRule> rules, final T data) {
  ...
  public static <T> void rulesExecutor(final ViolationBuilder violationBuilder, final Collection<ValidationRule> rules, final T data) {
    for (ValidationRule rule : rules) {
      ruleExecutor(violationBuilder, rule, data);
    }
  }

  public static <T> void ruleExecutor(final ViolationBuilder violationBuilder, final ValidationRule rule, final T data) {
